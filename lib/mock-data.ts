...
export const MOCK_USERS: User[] = [
  ...
  { id: 'user-11', username: 'mkunik', fullName: 'Kunik Martin', roleIds: ['role-4'], storeIds: [], active: true, workingHours: {
    sameAllWeek: false,
  ...
  { id: 'user-13', username: 'jlhotak', fullName: 'Lhoták Jan', roleIds: ['role-7'], storeIds: [], active: true, workingHours: {
    sameAllWeek: false,
    monday: { open: '08:00', close: '16:30', closed: false },
    tuesday: { open: '08:00', close: '16:30', closed: false },
    wednesday: { open: '08:00', close: '16:30', closed: false },
