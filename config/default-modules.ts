...
export const DEFAULT_MODULE_DEFINITIONS: ModuleDefinition[] = [
  ...
  },
  {
    ...
    description: 'Správa produktů, variant, kategorií a atributů',
    component: 'EshopProduktyModule',
    icon: 'ShoppingCart',
  },
  {
    id: 'eshop-eshopy',
    name: 'E-shop E-shopy',
    description: 'Správa e-shopů, přiřazení produktů, kategorií a přesměrování',
    component: 'EshopEshopyModule',
    icon: 'Store',
  },
  {
    id: 'eshop-objednavky',
    name: 'E-shop Objednávky',
    description: 'Správa objednávek a zákazníků e-shopu',
    component: 'EshopObjednavkyModule',
    icon: 'ClipboardList',
  },
  {
    id: 'eshop-page-builder',
    name: 'Page Builder',
    description: 'Správa bloků stránek e-shopů',
  ...
  },
  {
    id: 'eshop-blog',
    name: 'E-shop Blog',
    description: 'Správa blogových článků pro e-shopy',
  ...
  },
  {
    ...
    description: 'Statistiky a přehledy e-shopu',
    component: 'EshopDashboardModule',
    icon: 'BarChart3',
  },
];
