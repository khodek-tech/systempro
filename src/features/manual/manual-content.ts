...
export const MODULE_CONTENT: Record<string, { description: string; purpose: string; howToUse: string[]; faq: { q: string; a: string }[]; tips: string[] }> = {
  ...
  'tasks': {
    description: 'Přehled a správa úkolů s workflow schvalování, delegací a pravidelnými úkoly.',
    purpose: 'Modul Úkoly slouží ke kompletní správě pracovních úkolů. Vidíte úkoly přidělené vám, úkoly které jste zadali, pravidelné opakující se úkoly a celkový přehled. Úkoly mají workflow schvalování — zadavatel vytvoří úkol, příjemce ho zpracuje a odešle ke schválení, zadavatel schválí nebo vrátí. Úkoly lze delegovat na kolegu a vytvářet jako pravidelné s možností pozastavení.',
    howToUse: [
      '--- Základní orientace ---',
      'Na kartě modulu vidíte počet nevyřešených úkolů (badge).',
      'Klikněte na kartu pro otevření detailního přehledu se čtyřmi záložkami.',
      'Záložka "Moje úkoly" — úkoly přidělené vám, delegované na vás a úkoly čekající na vaši kontrolu.',
      'Záložka "Vytvořené mnou" — úkoly, které jste zadali ostatním (nebo sobě).',
      'Záložka "Pravidelné úkoly" — přehled opakujících se úkolů, které jste vytvořili. Zde lze pozastavit nebo obnovit automatické generování.',
      'Záložka "Všechny" — celkový přehled všech úkolů viditelných pro vaši roli.',
      '--- Vytvoření úkolu ---',
      'Klikněte na tlačítko "Nový úkol".',
      'Vyplňte název, popis, prioritu (Vysoká / Střední / Nízká) a termín splnění.',
      'Vyberte příjemce — konkrétního zaměstnance nebo celou prodejnu.',
      'Volitelně nastavte opakování (denní, týdenní, měsíční, roční).',
      'Klikněte "Vytvořit" — úkol se odešle příjemci.',
      '--- Plnění úkolu jako příjemce ---',
      'Nový úkol se vám zobrazí v záložce "Moje úkoly".',
      'Klikněte na úkol pro zobrazení detailu.',
      'Klikněte "Začít práci" — stav se změní na "Rozpracovaný". Tento krok můžete přeskočit.',
      'Po dokončení práce klikněte "Odeslat ke schválení" — úkol čeká na zadavatele.',
      '--- Schválení nebo vrácení úkolu (jako zadavatel) ---',
      'Úkol čekající na schválení se vám zobrazí v záložce "Vytvořené mnou".',
      'Otevřete detail úkolu a zkontrolujte práci.',
      'Klikněte "Schválit" pro dokončení úkolu, nebo "Vrátit" s uvedením důvodu.',
      '--- Vrácený úkol ---',
      'Pokud vám zadavatel úkol vrátí, uvidíte ho ve stavu "Vráceno" s důvodem vrácení v komentářích.',
      'Opravte nedostatky a znovu klikněte "Odeslat ke schválení".',
      '--- Delegace úkolu ---',
      'V detailu úkolu klikněte "Delegovat" a vyberte kolegu.',
      'Delegovaný kolega uvidí úkol ve svých "Moje úkoly" a zpracuje ho.',
      'Po dokončení kolega klikne "Odeslat delegujícímu" — úkol se vrátí vám ke kontrole.',
      'Vy pak schválíte nebo vrátíte práci kolegovi. Po vašem schválení jde úkol ke schválení původnímu zadavateli.',
      '--- Pravidelné úkoly ---',
      'Při vytváření úkolu nastavte opakování (denní, týdenní, měsíční, roční).',
      'Po schválení pravidelného úkolu systém automaticky vytvoří novou instanci s posunutým termínem.',
      'V záložce "Pravidelné úkoly" vidíte všechny své opakující se úkoly.',
      'Tlačítkem "Pozastavit" zastavíte automatické generování nových instancí.',
      'Tlačítkem "Obnovit" opět aktivujete generování.',
      '--- Komentáře a přílohy ---',
      'V detailu úkolu můžete přidávat komentáře s průběhem práce.',
      'Komentáře podporují přílohy — klikněte na ikonu sponky.',
      'URL adresy v popisu a komentářích se automaticky zobrazí jako klikatelné odkazy.',
    ],
    faq: [
      { q: 'Kdo schvaluje moje úkoly?', a: 'Úkoly schvaluje osoba, která je vytvořila (zadavatel). Pokud je úkol delegovaný, nejprve ho kontroluje delegující osoba a poté zadavatel.' },
      { q: 'Mohu delegovat úkol na kolegu?', a: 'Ano. V detailu úkolu klikněte "Delegovat" a vyberte kolegu. Kolega úkol zpracuje a vrátí vám ke kontrole.' },
      { q: 'Co když nestihnu termín?', a: 'Úkoly po termínu jsou označeny červeně. Informujte zadavatele o zpoždění a pokračujte v práci.' },
      { q: 'Co znamená záložka "Pravidelné úkoly"?', a: 'Zobrazuje přehled opakujících se úkolů, které jste vytvořili. Vidíte jejich stav a můžete pozastavit nebo obnovit automatické generování.' },
      { q: 'Jak pozastavím pravidelný úkol?', a: 'V záložce "Pravidelné úkoly" klikněte oranžové tlačítko "Pozastavit" u příslušného úkolu. Generování nových instancí se zastaví.' },
      { q: 'Co se stane po schválení pravidelného úkolu?', a: 'Systém automaticky vytvoří novou instanci se stejným názvem a popisem, ale s posunutým termínem podle nastaveného intervalu.' },
      { q: 'Co vidím, když mi někdo vrátí úkol?', a: 'Úkol se zobrazí ve stavu "Vráceno" v záložce "Moje úkoly". V komentářích najdete důvod vrácení. Opravte nedostatky a znovu odešlete ke schválení.' },
      { q: 'Jak funguje delegace?', a: 'Delegujete úkol na kolegu → kolega zpracuje a odešle delegujícímu → delegující zkontroluje a schválí/vrátí → po schválení jde úkol ke schválení zadavateli.' },
      { q: 'Co je záložka "Všechny"?', a: 'Zobrazuje všechny úkoly viditelné pro vaši roli — včetně schválených. Slouží jako celkový přehled.' },
    ],
    tips: [
      'Pravidelně kontrolujte záložku "Moje úkoly" pro nové přidělené úkoly.',
      'Přidávejte komentáře s průběhem práce — zadavatel vidí vaši aktivitu.',
      'U pravidelných úkolů využijte pozastavení, pokud dočasně nepotřebujete nové instance (např. během dovolené).',
      'Delegujte úkol, pokud ho nemůžete splnit sami — kolega dostane notifikaci.',
      'URL adresy v popisu úkolu i v komentářích se automaticky změní na klikatelné odkazy.',
    ],
  },
  'kpi-dashboard': {
