...
export function EmailModule() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative bg-sky-50 w-20 h-20 sm:w-28 sm:h-28 lg:w-[var(--module-icon-size)] lg:h-[var(--module-icon-size)] rounded-2xl sm:rounded-3xl lg:rounded-[var(--module-icon-radius)] flex items-center justify-center transition-all duration-500 group-hover:scale-105 group-hover:rotate-1 z-10"
        aria-hidden="true"
      >
        ...
        <div className="relative text-sky-500 transition-transform duration-500 group-hover:scale-105">
          <Mail className="w-10 h-10 sm:w-14 sm:h-14 lg:w-[var(--module-icon-inner)] lg:h-[var(--module-icon-inner)]" strokeWidth={1.2} />
        </div>
      </div>
      <div className="flex flex-col items-center space-y-3 z-10">
        <div className="flex items-center gap-3">
          <span className="text-xl sm:text-2xl lg:text-[length:var(--module-title-size)] font-extrabold tracking-tight transition-colors duration-300 text-sky-600">
            E-mail
          </span>
          {unreadCount > 0 && (
            <span
        ...
        <div
          className="w-8 h-0.5 bg-slate-200 rounded-full group-hover:w-16 group-hover:bg-sky-500 transition-all duration-500 opacity-50"
          aria-hidden="true"
        />
      </div>
    </button>
