...
export function PresenceModule() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative bg-blue-50 w-32 h-32 sm:w-36 sm:h-36 rounded-[36px] flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 z-10"
        aria-hidden="true"
      >
        ...
        <div className="relative text-blue-500 transition-transform duration-500 group-hover:scale-110">
          <Users className="w-[72px] h-[72px]" strokeWidth={1.2} />
        </div>
      </div>
