...
export function TasksModule() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative bg-violet-50 w-32 h-32 sm:w-36 sm:h-36 rounded-[36px] flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 z-10"
        aria-hidden="true"
      >
