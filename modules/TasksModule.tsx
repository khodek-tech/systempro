...
export function TasksModule() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative bg-violet-50 w-20 h-20 sm:w-28 sm:h-28 lg:w-[var(--module-icon-size)] lg:h-[var(--module-icon-size)] rounded-2xl sm:rounded-3xl lg:rounded-[var(--module-icon-radius)] flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 z-10"
        aria-hidden="true"
      >
      ...
      <div className="flex flex-col items-center space-y-3 z-10">
        ...
        <div
          className="w-12 h-1.5 bg-slate-100 rounded-full group-hover:w-20 group-hover:bg-violet-500 transition-all duration-500 opacity-50"
          aria-hidden="true"
        />
      </div>
    </button>
